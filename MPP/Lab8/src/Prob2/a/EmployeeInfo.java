...
public class EmployeeInfo {
	...
	public static void main(String[] args) {
		...
		System.out.println("joe equals joe2? " + joe1.equals(joe2));
		System.out.println(joe1.compareTo(joe2));

//		EmployeeNameComparator nameComp = new EmployeeNameComparator();
//		System.out.println("name joe equals name joe2? " + nameComp.compare(joe1, joe2));
