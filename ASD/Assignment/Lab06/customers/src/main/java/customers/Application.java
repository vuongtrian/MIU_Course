...
public class Application {
	...
	public static void main(String[] args) {
		...
		customerCollection.add(new Customer("Eric","Johnson","ejohnson@hotmail.com","0612342345",36, new Address("1000 S 4th street","Chicago","12544")));
		
//		customerCollection.print();

		/*
//		customerCollection.print2LowestAge();
		Comparator<Customer> comparator = Comparator.comparingInt(c -> c.getAge());
		AgeIterator<Customer> ageIterator = new AgeIterator<>(customerCollection.customers, comparator);
		ageIterator.sort();
		System.out.println("==== After sort =====");
		customerCollection.print();
		System.out.println("==== Smallest customer =====");
		System.out.println(customerCollection.customers.get(0));
		System.out.println("==== Second small customer =====");
		System.out.println(customerCollection.customers.get(1));

//		filter address in Chicago & zip code starts with “12”
		System.out.println("==== Customer in Chicago and has zip code starts with “12” =====");
		Predicate<Customer> predicate = (customer -> "Chicago".equals(customer.getAddress().getCity())
				&& "12".equals(customer.getAddress().getZip().substring(0,2)));
		customerCollection.print(customerCollection.filterAddressIterator(predicate));

		 */

//		print odd position in collection
		System.out.println("==== Customer at odd position =====");
		Iterator<Customer> oddPositionIterator = customerCollection.oddPositionIterator();
		while (oddPositionIterator.hasNext()){
			System.out.println(oddPositionIterator.next());
		}
	}
}
